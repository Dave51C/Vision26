...
TAG_CORNERS = {
    1:np.array([[  15.250,   0.000,  24.750],
                [   8.750,   0.000,  24.750],
                [   8.750,   0.000,  18.250],
                [  15.250,   0.000,  18.250]]
                )
  , 2:np.array([[  29.250,   0.000,  24.750],
                [  22.750,   0.000,  24.750],
                [  22.750,   0.000,  18.250],
                [  29.250,   0.000,  18.250]]
                )
  , 3:np.array([[  63.250,   0.000,  24.750],
                [  56.750,   0.000,  24.750],
                [  56.750,   0.000,  18.250],
                [  63.250,   0.000,  18.250]]
                )
  , 4:np.array([[  99.250,   0.000,  24.750],
                [  92.750,   0.000,  24.750],
                [  92.750,   0.000,  18.250],
                [  99.250,   0.000,  18.250]]
                )
  , 5:np.array([[ 143.000,  82.750,  24.750],
                [ 143.000,  76.250,  24.750],
                [ 143.000,  76.250,  18.250],
                [ 143.000,  82.750,  18.250]]
                )
  , 6:np.array([[ 143.000, 118.750,  24.750],
                [ 143.000, 112.250,  24.750],
                [ 143.000, 112.250,  18.250],
                [ 143.000, 118.750,  18.250]]
                )
  , 7:np.array([[ 143.000, 132.750,  24.750],
                [ 143.000, 126.250,  24.750],
                [ 143.000, 126.250,  18.250],
                [ 143.000, 132.750,  18.250]]
                )
  , 8:np.array([[ 116.750, 196.500,  24.750],
